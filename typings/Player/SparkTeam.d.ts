...
interface SparkTeam {
     ...
     * @example var ownerId = Spark.getTeams().getTeam(myTeamId).getOwnerId();
     */
    getOwnerId(): string
    /**
     * Gets the teamId of this team.
     * @example var teamId = Spark.getTeams().getTeam(myTeamId).getTeamId();
     */
    getTeamId(): string
    /**
     * Gets the name of this team.
     * @example var teamName = Spark.getTeams().getTeam(myTeamId).getTeamName();
     */
    getTeamName(): string
    /**
     * Gets the teamType of this team.
     * @example var teamType = Spark.getTeams().getTeam(myTeamId).getTeamType();
     */
    getTeamType(): string
    /**
     * Gets an array containing the playerIds of the members of this team.
     * @example var memberIds = Spark.getTeams().getTeam(myTeamId).getMemberIds();
     */
    getMemberIds(): string[]
    /**
     * Updates the ownerId of this team.
     * Returns true if the ownerId was successfully updated, otherwise false.
     * @example var success = Spark.getTeams().getTeam(myTeamId).setOwnerId(newOwnerId);
     */
    setOwnerId(playerId: string): boolean
    /**
     * Sets the name of this team.
     * @example var success = Spark.getTeams().getTeam(myTeamId).setTeamName("TeamName");
     */
    setTeamName(teamName: string): boolean
    /**
     * Adds the given playerIds as members to this team.
     * @example Spark.getTeams().getTeam(myTeamId).addMembers(myPlayerId1, myPlayerId2);
     */
    addMembers(playerIds: string[]): void
    /**
     * Removes the given playerIds from the list of members of this team.
     * @example Spark.getTeams().getTeam(myTeamId).removeMembers(myPlayerId1, myPlayerId2);
     */
     ...
     * @example var success = Spark.getTeams().getTeam(myTeamId).drop();
     */
    drop(): boolean
    /**
     * Lists the last 
     * @example var history = Spark.getTeams().getTeam(myTeamId).listChatMessages(50, 0);
     */
     ...
     * @example var success = Spark.getTeams().getTeam(myTeamId).deleteChatMessage(chatMessageId);
     */
     ...
     * @example var success = Spark.getTeams().getTeam(myTeamId).addAchievement(achievementShortCode);
     */
     ...
     * @example var success = Spark.getTeams().getTeam(myTeamId).removeAchievement(achievementShortCode);
     */
