...
interface SparkPlayer {
     ...
     * @example var displayName = Spark.getPlayer().getDisplayName();
     */
     ...
     * @example var userName = Spark.getPlayer().getUserName();
     */
    getUserName(): string
    /**
     * Gets the GameSparks ID of the player
     * @example var playerId = Spark.getPlayer().getPlayerId();
     */
    getPlayerId(): string
    /**
     ...
     * @example Spark.getPlayer().persist();
     */
    persist(): void
    /**
     ...
     * @param quantity the amount to credit
     * @param reason the reason for the credit
     * @example Spark.getPlayer().credit2(20, "Loyalty Bonus");
     */
    credit2(quantity: number, reason: string): void
    /**
     * Credits the currency2 balance of the player with the amount specified.
     * @param quantity the amount to credit
     * @example Spark.getPlayer().credit2(20);
     */
     ...
     * @param quantity the amount to debit
     * @param reason the reason for the debit
     * @example Spark.getPlayer().debit2(5, "Loser Penalty");
     */
     ...
     * Returns true if the debit was successful, false if the current balance was not sufficient.
     * @param quantity the amount to debit
     * @example Spark.getPlayer().debit2(5);
     */
     ...
     * @param quantity the amount to credit
     * @param reason the reason for the credit
     * @example Spark.getPlayer().credit3(20, "Loyalty Bonus");
     */
    credit3(quantity: number, reason: string): void
    /**
     * Credits the currency3 balance of the player with the amount specified.
     * @param quantity the amount to credit
     * @example Spark.getPlayer().credit3(20);
     */
     ...
     * @param quantity the amount to debit
     * @param reason the reason for the debit
     * @example Spark.getPlayer().debit4(5, "Loser Penalty");
     */
     ...
     * Returns true if the debit was successful, false if the current balance was not sufficient.
     * @param quantity the amount to debit
     * @example Spark.getPlayer().debit4(5);
     */
     ...
     * @param quantity the amount to debit
     * @param reason the reason for the debit
     * @example Spark.getPlayer().debit5(5, "Loser Penalty");
     */
     ...
     * Returns true if the debit was successful, false if the current balance was not sufficient.
     * @param quantity the amount to debit
     * @example Spark.getPlayer().debit5(5);
     */
     ...
     * @param quantity the amount to credit
     * @param reason the reason for the credit
     * @example Spark.getPlayer().credit6(20, "Loyalty Bonus");
     */
    credit6(quantity: number, reason: string): void
    /**
     * Credits the currency6 balance of the player with the amount specified.
     * @param quantity the amount to credit
     * @example Spark.getPlayer().credit6(20);
     */
     ...
     * @param quantity the amount to debit
     * @param reason the reason for the debit
     * @example Spark.getPlayer().debit6(5, "Loser Penalty");
     */
     ...
     * Returns true if the debit was successful, false if the current balance was not sufficient.
     * @param quantity the amount to debit
     * @example Spark.getPlayer().debit6(5);
     */
    debit6(quantity: number): boolean
    /**
     * Gets the currency1 balance of the player.
     * @example var bal = Spark.getPlayer().getBalance1();
     */
    getBalance1(): number
    /**
     ...
     * @param quantity the amount to credit
     * @param reason the reason for the credit
     * @example Spark.getPlayer().credit("GOLD", 20, "Loyalty Bonus");
     */
    credit(shortCode: string, quantity: number, reason: string): void
    /**
     * Gets the currency4 balance of the player.
     * @example var bal = Spark.getPlayer().getBalance4();
     */
    getBalance4(): number
    /**
     * Gets the currency5 balance of the player.
     * @example var bal = Spark.getPlayer().getBalance5();
     */
    getBalance5(): number
    /**
     * Gets the currency6 balance of the player.
     * @example var bal = Spark.getPlayer().getBalance6();
     */
    getBalance6(): number
    /**
     ...
     * @example var bal = Spark.getPlayer().getBalance("GOLD");
     */
     ...
     * @example var goodsAdded = Spark.getPlayer().addVGood(vgShortCode, 42);
     */
     ...
     * @example var goodsAdded = Spark.getPlayer().addVGood(vgShortCode, 42, "Loyalty bonus");
     */
     ...
     * @example var goodsUsed = Spark.getPlayer().useVGood(vgShortCode, 34, "Loser penalty");
     */
     ...
     * @param shortCode the virtual good's short code
     * @param quantity the amount to consume
     * @example var goodsUsed = Spark.getPlayer().useVGood(vgShortCode, 34);
     */
     ...
     * @param shortCode the virtual good's short code
     * @example var hasGood = Spark.getPlayer().hasVGood(vgShortCode);
     */
     ...
     * @example var achievementAdded = Spark.getPlayer().addAchievement(shortCode);
     */
     ...
     * @example var achievementRemoved = Spark.getPlayer().removeAchievement(shortCode);
     */
     ...
     * @param shortCode The shortCode of the achievement
     * @example var hasAchievement = Spark.getPlayer().hasAchievement(shortCode);
     */
     ...
     * @example var messageDismissed = Spark.getPlayer().dismissMessage(messageId);
     */
     ...
     * @example var doesPasswordMatch = Spark.getPlayer().validatePassword(passwordEnteredByPlayer);
     */
    validatePassword(password: string): boolean
    /**
     * Sets a new password for this player.
     * @param password the password to set
     * @example Spark.getPlayer().setPassword(password);
     */
    setPassword(password: string): void
    /**
     * Boolean value indicating if this player is currently being hidden from leaderboards.
     * @example var hidden = Spark.getPlayer().isHidden();
     */
     ...
     * @example Spark.getPlayer().hideOnLeaderboards();
     */
     ...
     * @example Spark.getPlayer().showOnLeaderboards();
     */
    showOnLeaderboards(): void
    /**
     * Gets push registrations of the player
     * @example var pushRegistrations = Spark.getPlayer().getPushRegistrations();
     */
     ...
     * @example Spark.getPlayer().disconnect(true);
     */
    disconnect(excludeCurrent: boolean): void
    /**
     * Gets all achievements from this player
     * @example Spark.getPlayer().getAchievements();
     */
     ...
     * @example var isMatch = Spark.getPlayer().matchesMongoQueryString("");
     */
    matchesMongoQueryString(mongoQueryString: string): boolean
    /**
     * Returns the current experiment segments of the player.
     * @example var experiments = Spark.getPlayer().getExperimentSegments();
     */
     ...
     * @example var removed = Spark.getPlayer().removeExperiment();
     */
     ...
     * @example var added = Spark.getPlayer().setExperimentSegment(47, "FireSale");
     */
     ...
     * @example var userName = Spark.loadPlayer("57f4af757d196627bc79abc9").deletePlayer();
     */
    deletePlayer(): void
    /**
     ...
     * @param name The name in the name value pair
     * @example Spark.getChallenge().removePrivateData("name");
     */
