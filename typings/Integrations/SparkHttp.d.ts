...
interface SparkHttp {
     ...
     * @example Spark.getHttp(url).setBasicAuth("myusername", "mypassword");
     */
     ...
     * @param form the HTTP form data
     * @example Spark.getHttp(url).postXml(xmlForm);
     */
     ...
     * @example Spark.getHttp(url).postString(data);
     */
     ...
     * @param form the HTTP form data
     * @example Spark.getHttp(url).putXml(xmlForm);
     */
     ...
     * @example Spark.getHttp(url).putString(data);
     */
    putString(data: string): SparkHttpResponse
    /**
     * Perform a HTTP DELETE request
     * @example var response = Spark.getHttp(url).delete();
     */
