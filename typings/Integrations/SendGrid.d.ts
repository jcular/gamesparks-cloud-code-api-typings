...
interface SendGrid {
     ...
     * @example mySendGrid.addTo("info@gamesparks.com", "GameSparks")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.setFrom("info@gamesparks.com", "GameSparks")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.setReplyTo("info@gamesparks.com")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.setBcc("info@gamesparks.com")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.setSubject("Hello from GameSparks")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.setText("Welcome to using SendGrid via GameSparks")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.setHtml("<b>Welcome to using SendGrid via GameSparks</b>")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.addUploaded("7359237762da4245add41e44bc994cdd")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.addDownloadable("SHORTCODE")
     */
     ...
     * @returns This SendGrid object
     * @example mySendGrid.addHeader("X-Sent-Using", "SendGrid-API")
     */
