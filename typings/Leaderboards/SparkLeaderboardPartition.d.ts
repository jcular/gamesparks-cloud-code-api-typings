...
interface SparkLeaderboardPartition {
     ...
     * @example var desc = Spark.getLeaderboards().getLeaderboard(shortCode).getDescription();
     */
    getDescription(): string
    /**
     * Returns the name of this leaderboard.
     * @example var shortCode = Spark.getLeaderboards().getLeaderboard(shortCode).getName();
     */
    getName(): string
    /**
     * Returns the shortCode of this leaderboard.
     * @example var shortCode = Spark.getLeaderboards().getLeaderboard(shortCode).getShortCode();
     */
    getShortCode(): string
    /**
     * Returns the total number of entries in this leaderboard.
     * @example var count = Spark.getLeaderboards().getLeaderboard(shortCode).getEntryCount();
     */
     ...
     * @example var count = Spark.getLeaderboards().getLeaderboard(shortCode).getEntryCountForIdentifier("myPlayerId");
     */
    getEntryCountForIdentifier(identifier: string): number
    /**
     * Returns a cursor over all the entries in this leaderboard.
     * @example var cursor = Spark.getLeaderboards().getLeaderboard(shortCode).getEntries();
     */
     ...
     * @example var cursor = Spark.getLeaderboards().getLeaderboard(shortCode).getEntries(mycount, myoffset);
     */
    getEntries(count: number, offset: number): SparkLeaderboardCursor
    /**
     * Returns true if this leaderboard has or can have partitions.
     * @example var isPartitioned = Spark.getLeaderboards().getLeaderboard(shortCode).isPartitioned();
     */
    isPartitioned(): boolean
    /**
     * Returns true if this leaderboard is a single partition of a parent leaderboard.
     * @example var isPartitioned = Spark.getLeaderboards().getLeaderboard(shortCode).isPartition();
     */
    isPartition(): boolean
    /**
     * Returns an array containing the partitions of this leaderboard if it is partitioned, otherwise an empty array is returned.
     * @example var partitions = Spark.getLeaderboards().getLeaderboard(shortCode).getPartitions();
     */
     ...
     * @example Spark.getLeaderboards().getLeaderboard(shortCode).getPartitions()[0].drop();
     */
    drop(): void
    /**
     * See #drop.  Additionally deletes the underlying running total data, resetting any record of players' scores.
     * @example leaderboard.drop(true);
     */
     ...
     * @example Spark.getLeaderboards().getLeaderboard(shortCode).getPartitions()[0].archive();
     */
    archive(): void
    /**
     * Returns true if this partition has been archived.
     * @example Spark.getLeaderboards().getLeaderboard(shortCode).getPartitions()[0].isArchived();
     */
    isArchived(): boolean
    /**
     ...
     * @example leaderboard.getScoreFields();
     */
     ...
     * @example leaderboard.deleteEntry(myPlayerId, true);
     */
     ...
     * @example leaderboard.rebuildLeaderboard(true);
     */
