...
interface SparkChallenge {
     ...
     * @example var runState = Spark.getChallenge(mychallengeid).getRunState();
     */
    getRunState(): string
    /**
     * Gets the ID of this challenge.
     * @example var id = Spark.getChallenge(mychallengeid).getId();
     */
    getId(): string
    /**
     * Returns the shortCode of the challenge
     * Can be useful when block or code should only run for a particular challenge type.
     * @example var shortCode = Spark.getChallenge(mychallengeid).getShortCode();
     */
    getShortCode(): string
    /**
     ...
     * @example Spark.getChallenge(mychallengeid).winChallenge(aPlayer);
     */
    winChallenge(winner: SparkPlayer): void
    /**
     * Complete the challenge with no winner.
     * @example Spark.getChallenge(mychallengeid).drawChallenge();
     */
    drawChallenge(): void
    /**
     ...
     * @example Spark.getChallenge(mychallengeid).startChallenge();
     */
    startChallenge(): void
    /**
     ...
     * @example var players = Spark.getChallenge(mychallengeid).getChallengedPlayerIds();
     */
    getChallengedPlayerIds(): string[]
    /**
     * Returns a list of Players ID's that can be used to load the player details using Spark.getPlayer(String player)
     * @returns The array of player Ids who have accepted this challenge
     * @example var players = Spark.getChallenge(mychallengeid).getAcceptedPlayerIds();
     */
    getAcceptedPlayerIds(): string[]
    /**
     * Returns a list of Players ID's that can be used to load the player details using Spark.getPlayer(String player)
     * @returns The array of player Ids who have declined this challenge
     * @example var players = Spark.getChallenge(mychallengeid).getDeclinedPlayerIds()
     */
    getDeclinedPlayerIds(): string[]
    /**
     * Gets the player id of whoever issued the challenge.
     * @example var challengerId = Spark.getChallenge(mychallengeid).getChallengerId();
     */
    getChallengerId(): string
    /**
     * Gets the end date of the challenge.
     * @example var endDate = Spark.getChallenge(mychallengeid).getEndDate();
     */
    getEndDate(): date
    /**
     * Gets the expiry date of the challenge.
     * @example var expiryDate = Spark.getChallenge(mychallengeid).getExpiryDate();
     */
    getExpiryDate(): date
    /**
     * Gets the start date of the challenge.
     * @example var startDate = Spark.getChallenge(mychallengeid).getStartDate();
     */
    getStartDate(): date
    /**
     ...
     * @example var challenge = Spark.getChallenge(mychallengeid).consumeTurn(playerId);
     */
     ...
     * @param playerId the id of the player who has taken their turn
     * @example var challenge = Spark.getChallenge(mychallengeid).takeTurn(playerId);
     */
    takeTurn(playerId: string): boolean
    /**
     * Removes a player from this challenge.
     * @param playerId the id of the player to remove
     * @example var challenge = Spark.getChallenge(mychallengeid).removePlayer(playerId);
     */
