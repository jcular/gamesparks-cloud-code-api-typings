...
interface SparkMatch {
     ...
     * @validity All Scripts
     * @example match.enableRealtime('MY_RT_SCRIPT');
     */
     ...
     * @validity All Scripts
     * @example var isEnabledForRealtime = match.isRealtimeEnabled();
     */
